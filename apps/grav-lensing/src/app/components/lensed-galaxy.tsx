...
const LensedGalaxyDisplay = styled.img<LensedGalaxyDisplayProps>`
  ...
  transform: translate(-50%, -50%) scale(${props => props.scale}) matrix(${props => `${props.distort[0]}, ${props.distort[1]}, ${props.distort[2]}, ${props.distort[3]}, 0, 0`});
...
export const LensedGalaxy = ({
  ...
  return (
    <LensedGalaxyDisplay src='assets/img/gl-galaxy.png' alt='Lensed Galaxy' displayPosition={displayPosition} scale={scale} distort={distort} />
  )
}
