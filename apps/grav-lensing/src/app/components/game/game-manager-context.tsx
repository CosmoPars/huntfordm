...
const defaultContext: GameManagerContextType = {
  ...
  scanGridSquare: () => { throw new Error('Not Implemented')},
  revealGridSquare: () => { throw new Error('Not Implemented') },
  getEncodedUrl: () => {throw new Error('Not Implemented')}
}

export const GameManagerContext = createContext<GameManagerContextType>(defaultContext)
