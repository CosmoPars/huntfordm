...
const LineSegment = styled.div<LineSegmentProps>`
  ...
  background: linear-gradient(90deg,
    ${({ lineColor }) => `rgba(${lineColor[0]}, ${lineColor[1]}, ${lineColor[2]},0)`}0%,
    ${({ lineColor }) => `rgba(${lineColor[0]}, ${lineColor[1]}, ${lineColor[2]},1)`} 90%);
`
...
export const Line = ({
  ...
  return (
    <LineLayout {...positionProps}>
      ...
      <ArrowHead height='7px' color={`rgb(${lineColor[0]}, ${lineColor[1]}, ${lineColor[2]})`} />
    </LineLayout>
  )
}
