...
const ButtonPosition = styled.div`
  ...
  type WarningMessageProps = {
    ...
    if (isMobile) {
      return (
        <div style={{ backgroundColor: 'yellow', padding: '10px', position: 'fixed', top: 150, left: 15, right: 15, zIndex: 9999, textAlign: 'center' }}>
          <p>
            Notice: The Hunt for Dark Matter web application is optimised 
            for desktop and probably won't display correctly on mobile devices. 
