    ...
    <Background imgSrc='/assets/img/star-background.jpg'>
      ...
      <ContainerDiv>
        <StyledText>
            ...
            <br />virtual universe. Click on a square in the sky
            <br />to scan and stack that square's galaxies.

        </StyledText>

        <Text>You start with $50,000 worth of funding and every scan costs you some funds. 
          <br/> When you scan a square with a clump of dark matter in it you win some funding back.
          </Text>

        <Text>Win the game by using your new knowledge of weak lensing
        <br/>to find all the dark matter clumps before funding runs out!</Text>
